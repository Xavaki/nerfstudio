...
def hanerf_occlusion_mask_loss(targets, rgb, mask):
    """Computes color loss, taking into account a learned occlusion uncertainty map

    Args:
        targets (_type_): original rgbs
        rgb (_type_): computed rgbs
        mask (_type_): occlusion uncertainty map
    ...
    size_delta = 0.006 # xx see opt.py in original implementation
