...
echo "singularity exec --nv /homedtic/xpavon/nerfstudio_root/nerfstudio_0.1.19.sif python3 /homedtic/xpavon/nerfstudio_root/nerfstudio/scripts/train.py hanerfacto --viewer.quit-on-train-completion True --experiment-name maskha-1682947572 --data data/mask/outputs/mask_32 --pipeline.datamanager.train-num-images-to-sample-from 1 ; sbatch /homedtic/xpavon/nerfstudio_root/nerfstudio/bash_scripts/maskha-1682947572/1-maskha.bash"
echo -------------------
echo -------------------
